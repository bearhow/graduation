...
public class meeting_number extends AppCompatActivity {
    LinearLayout linearLayout;
    TableLayout tableLayout;
    Button button;
    private ArrayList<ArrayList<String>> lists1 = new ArrayList<ArrayList<String>>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_meeting_number);

//        new Thread(new Runnable() {
//            @Override
//            public void run() {
//                ArrayList<ArrayList<String>> lists1 = DBOpenHelper.selectMeeting();
//                Message message = handler.obtainMessage();
//                message.obj=lists1;
//                handler.sendMessage(message);
//                lists1= DBOpenHelper.selectMeeting();
//            }
//        }).start();
//        for(;true;) {
//            if(lists1.size()!=0) {
//                initXml();//代码动态创建布局
//                addView(lists1);//给创建的布局中添加控件
//                break;
//            }else {
//
//            }
//        }
    ...
    private void addView(ArrayList<ArrayList<String>> lists) {
